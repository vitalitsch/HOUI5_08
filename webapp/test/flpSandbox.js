		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#dehuberittraining08zhoui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dehuberittraining08zhoui5-display": {
								"semanticObject": "dehuberittraining08zhoui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=de.huberit.training08.zhoui5",
									"url": sap.ui.require.toUrl("de/huberit/training08/zhoui5")
								}
							}
						}
					}
